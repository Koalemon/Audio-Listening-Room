...
export class CoreEngine {
    ...
    /**
     * @param {Float64Array} draw_data
     * @param {number} canvas_width
     * @param {number} canvas_height
     * @returns {Float64Array}
     */
    compute_bars(draw_data, canvas_width, canvas_height) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            const ptr0 = passArrayF64ToWasm0(draw_data, wasm.__wbindgen_export);
            const len0 = WASM_VECTOR_LEN;
            wasm.coreengine_compute_bars(retptr, this.__wbg_ptr, ptr0, len0, canvas_width, canvas_height);
    ...
    fetch_and_process_playlist() {
        const ret = wasm.coreengine_fetch_and_process_playlist(this.__wbg_ptr);
     ...
     * @returns {Float64Array}
     */
    get_symmetric_spectrum(data) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            const ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_export);
            const len0 = WASM_VECTOR_LEN;
            wasm.coreengine_get_symmetric_spectrum(retptr, this.__wbg_ptr, ptr0, len0);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var v2 = getArrayF64FromWasm0(r0, r1).slice();
            wasm.__wbindgen_export5(r0, r1 * 8, 8);
     ...
     * @returns {Float64Array}
     */
    get_visualizer_bars(data) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            const ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_export);
            const len0 = WASM_VECTOR_LEN;
            wasm.coreengine_get_visualizer_bars(retptr, this.__wbg_ptr, ptr0, len0);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var v2 = getArrayF64FromWasm0(r0, r1).slice();
            wasm.__wbindgen_export5(r0, r1 * 8, 8);
        ...
        __wbg_new_typed_323f37fd55ab048d: function(arg0, arg1) {
            try {
                ...
                var cb0 = (arg0, arg1) => {
                    ...
                    state0.a = 0;
                    try {
                        return __wasm_bindgen_func_elem_293(a, state0.b, arg0, arg1);
                    } finally {
                        state0.a = a;
                    }
                };
...
function __wasm_bindgen_func_elem_234(arg0, arg1, arg2) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.__wasm_bindgen_func_elem_234(retptr, arg0, arg1, addHeapObject(arg2));
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        if (r1) {
            throw takeObject(r0);
...
function __wasm_bindgen_func_elem_293(arg0, arg1, arg2, arg3) {
    wasm.__wasm_bindgen_func_elem_293(arg0, arg1, addHeapObject(arg2), addHeapObject(arg3));
}
